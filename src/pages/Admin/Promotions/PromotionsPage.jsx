...
const PromotionsPage = () => {
  ...
  const getPromotionTypeName = (typeCode) => {
    const type = promotionTypes.find((t) => t.promotionTypeCode === typeCode);
  ...
  const isPercentType = (typeCode) => {
    ...
    const t = promotionTypes.find(
      (p) => p.promotionTypeCode === typeCode || p.code === typeCode
    );
    const name = t?.promotionTypeName || t?.typeName || "";
    ...
    },
    {
      ...
      render: (item) => {
        ...
        const type = promotionTypes.find(
          (t) => t.promotionTypeCode === item.promotionTypeCode
        );
        const isPercent =
          (item.promotionTypeName &&
            item.promotionTypeName.toLowerCase().includes("percent")) ||
          (type &&
            type.promotionTypeName &&
            type.promotionTypeName.toLowerCase().includes("percent")) ||
