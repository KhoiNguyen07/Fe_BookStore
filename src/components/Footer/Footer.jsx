  ...
  return (
    <footer className="bg-[#f5f5f5] text-gray-700">
      ...
      <button
        ...
        className={`fixed right-6 bottom-24 w-12 h-12 rounded-full bg-blue-600 text-white shadow-lg flex items-center justify-center transition-opacity ${
      ...
      <div className="fixed bottom-6 right-6 z-50">
        ...
        {/* Chat Window */}
        {isChatOpen && (
          <div className="absolute bottom-16 right-0 w-80 h-96 md:w-[28rem] md:h-[36rem] bg-white rounded-lg shadow-2xl border border-gray-200 flex flex-col animate-in slide-in-from-bottom-5 fade-in duration-300">
            {/* Chat Header */}
            <div className="bg-blue-600 text-white p-5 rounded-t-lg flex items-center justify-between">
            ...
            <div className="flex-1 p-4 overflow-y-auto space-y-4">
              {chatMessages.map((message) => (
                ...
                >
                  <div
                    className={`max-w-[18rem] md:max-w-[22rem] px-4 py-3 rounded-lg ${
                      message.sender === "user"
            ...
            >
              <div className="flex space-x-3">
                ...
                <button
                  ...
                  className="bg-blue-600 text-white px-5 py-3 rounded-lg hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors"
                >
                  <svg
                    className="w-5 h-5"
                    fill="none"
